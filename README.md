...
#### For Windows
Follow this tutorial: https://www.howtogeek.com/670447/how-to-copy-the-full-path-of-a-file-on-windows-10/#:~:text=Here%27s%20how.,select%20%E2%80%9CCopy%20As%20Path.%E2%80%9D

#### For Mac/Linux
Follow this tutorial: https://themacbeginner.com/copy-full-path-file-folder-finder-mac-osx/

NOTE: The end of your path, should be the name of the folder. By default this should be "

to do this open up conda with the methods I provided in the conda installation section once conda is opened type in the following line (feel free to copy and paste it as well):
